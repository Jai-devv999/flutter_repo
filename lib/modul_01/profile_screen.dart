...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Placeholder diganti dengan konten Tahap 7.2
      body: Center(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Nama mahasiswa
              const Text(
                'Jainul Muchlisin', // Ganti dengan nama asli Anda
                style: TextStyle(
                  fontSize: 22,
              ...
              Container(
                ...
                child: const Text(
                  'NIM: 362558302052', // Ganti dengan NIM asli Anda
                  style: TextStyle(
                    fontSize: 13,
